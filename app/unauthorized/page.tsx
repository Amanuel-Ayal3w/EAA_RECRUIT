  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-[#0A0A0A] px-6 py-16 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-[580px] gap-10 w-full">
        ...
        {/* Lock icon */}
        <div className="flex items-center justify-center w-[80px] h-[80px] border-2 border-[#FF6B35]/40 bg-[#FF6B35]/05">
          <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
            <rect x="6" y="16" width="24" height="18" stroke="#FF6B35" strokeWidth="1.6" />
            <path d="M11 16v-6a7 7 0 0 1 14 0v6" stroke="#FF6B35" strokeWidth="1.6" strokeLinecap="square" />
            <circle cx="18" cy="25" r="2.5" fill="#FF6B35" />
            <line x1="18" y1="27.5" x2="18" y2="31" stroke="#FF6B35" strokeWidth="1.6" strokeLinecap="square" />
          </svg>
        </div>

        <div>
          <p className="font-ibm-mono text-[9px] text-[#FF6B35] tracking-[3px] mb-3">[SYS-403] // ACCESS DENIED</p>
          <h1 className="font-grotesk text-[80px] md:text-[120px] font-bold text-[#F5F5F0] leading-none tracking-[-4px]">
            4<span className="text-[#FF6B35]">0</span>3
          </h1>
        ...
        <div className="w-full border border-[#1D1D1D] bg-[#0D0D0D]">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-[#1D1D1D]">
            ...
            <span className="font-ibm-mono text-[8px] text-[#555] tracking-[1.5px]">ACCESS CONTROL MATRIX</span>
          </div>
          {[
            ...
            <div key={i} className={`flex items-center justify-between gap-4 px-5 py-4 ${i < 3 ? "border-b border-[#1D1D1D]" : ""}`}>
              <span className="font-ibm-mono text-[9px] text-[#888] tracking-[0.5px] flex-1 text-left">{row.route}</span>
              <span className="font-ibm-mono text-[8px] text-[#444] tracking-[1px]">{row.role}</span>
              <div className={`flex items-center gap-1.5 shrink-0`}>
                <div className={`w-[5px] h-[5px] rounded-full ${row.allowed ? "bg-[#FFD600]" : "bg-red-500"}`} />
                <span className={`font-ibm-mono text-[8px] tracking-[1px] ${row.allowed ? "text-[#FFD600]" : "text-red-400"}`}>
        ...
        {/* Security notice */}
        <div className="flex items-start gap-3 w-full px-4 py-4 border border-[#FF6B35]/20 bg-[#FF6B35]/04 text-left">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="text-[#FF6B35] mt-[1px] shrink-0">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full">
          <Link href="/login" className="flex flex-1 items-center justify-center h-[52px] bg-[#FFD600] hover:bg-[#e6c200] transition-colors">
            <span className="font-grotesk text-[11px] font-bold text-[#0A0A0A] tracking-[2px]">SIGN IN WITH CORRECT ROLE</span>
          </Link>
          <Link href="/" className="flex flex-1 items-center justify-center h-[52px] border-2 border-[#2D2D2D] hover:border-[#FFD600] transition-colors">
            <span className="font-ibm-mono text-[9px] text-[#888] hover:text-[#FFD600] tracking-[1.5px] transition-colors">RETURN TO HOME</span>
          </Link>
        </div>
      </div>
    </div>
