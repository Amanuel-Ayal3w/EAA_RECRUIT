...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full bg-[#0A0A0A] overflow-hidden">
      ...
      {/* Left panel — branding */}
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 border-r border-[#1D1D1D] px-12 py-12 relative z-10">
        <div className="flex flex-col gap-8">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="font-ibm-mono text-[7px] text-[#555] tracking-[1px]">ETHIOPIAN AVIATION ACADEMY</span>
            </div>
          </div>

          <div className="mt-8">
            <h2 className="font-grotesk text-[40px] font-bold text-[#F5F5F0] leading-[1.05] tracking-[-1px] text-balance">
            ...
            <p className="font-ibm-mono text-[11px] text-[#555] tracking-[1px] leading-[1.7] mt-6 max-w-[280px]">
          ...
          <div className="flex flex-col gap-3 mt-4">
            {[
              ...
              <div key={item.label} className="flex items-start gap-3">
                <div className="w-[5px] h-[5px] bg-[#FFD600] mt-[5px] shrink-0" />
                <div>
                  <span className="font-ibm-mono text-[9px] font-bold text-[#FFD600] tracking-[1.5px] block">{item.label}</span>
                  <span className="font-ibm-mono text-[8px] text-[#444] tracking-[0.5px]">{item.desc}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 relative z-10">
        <div className="w-full max-w-[420px] flex flex-col gap-8">
          ...
          {/* Header */}
          <div>
            <p className="font-ibm-mono text-[9px] text-[#FFD600] tracking-[2px] mb-2">[AUTH] // LOGIN</p>
            <h1 className="font-grotesk text-[26px] font-bold text-[#F5F5F0] tracking-[-0.5px] text-balance">{t.title}</h1>
            <p className="font-ibm-mono text-[8px] text-[#444] tracking-[1.5px] mt-1">{t.subtitle}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="font-ibm-mono text-[8px] text-[#444] hover:text-[#FFD600] tracking-[1px] transition-colors">
                  {t.forgot}
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full h-[48px] bg-[#0D0D0D] border border-[#2D2D2D] px-4 pr-12 font-ibm-mono text-[12px] text-[#F5F5F0] placeholder-[#333] focus:outline-none focus:border-[#FFD600] transition-colors"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((v) => !v)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#444] hover:text-[#FFD600] transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="h-[52px] bg-[#FFD600] hover:bg-[#e6c200] disabled:opacity-50 transition-colors flex items-center justify-center gap-3"
            >
              {loading ? (
                <div className="w-[16px] h-[16px] border-2 border-[#0A0A0A]/30 border-t-[#0A0A0A] rounded-full animate-spin" />
              ) : null}
              <span className="font-grotesk text-[12px] font-bold text-[#0A0A0A] tracking-[2px]">{t.submit}</span>
            </button>
          </form>

          {/* Role detection note */}
          <div className="flex items-start gap-2 px-3 py-3 bg-[#FFD600]/04 border border-[#FFD600]/15">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className="text-[#FFD600] mt-[1px] shrink-0">
              <circle cx="6" cy="6" r="5" stroke="currentColor" strokeWidth="1.2" />
              <path d="M6 5v4M6 3.5v.5" stroke="currentColor" strokeWidth="1.2" strokeLinecap="square" />
            </svg>
            <span className="font-ibm-mono text-[8px] text-[#555] tracking-[0.5px] leading-[1.7]">{t.roles}</span>
          </div>

          {/* Register link */}
          <div className="flex items-center gap-3">
            <div className="flex-1 h-[1px] bg-[#1D1D1D]" />
            <span className="font-ibm-mono text-[8px] text-[#333] tracking-[1px]">{t.noAccount}</span>
            <div className="flex-1 h-[1px] bg-[#1D1D1D]" />
          </div>
          <Link
            href="/register"
          ...
          >
            <span className="font-ibm-mono text-[9px] text-[#888] hover:text-[#FFD600] tracking-[1.5px] transition-colors">{t.register}</span>
          </Link>

          <p className="font-ibm-mono text-[7px] text-[#333] tracking-[0.5px] text-center leading-[1.8]">
