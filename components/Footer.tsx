  ...
  return (
    <footer className="flex flex-col w-full bg-[#050505]">
        ...
        <div className="flex flex-col gap-6 md:w-[300px] md:shrink-0">
          <div className="flex items-center gap-[12px]">
            ...
            <div className="flex flex-col leading-none gap-[2px]">
              ...
              <span className="font-ibm-mono text-[8px] text-[var(--c-text-muted)] tracking-[1px]">
                ETHIOPIAN AVIATION ACADEMY
              </span>
            </div>
          </div>
          <p className="font-ibm-mono text-[11px] text-[var(--c-text-muted)] tracking-[0.5px] leading-[1.7] max-w-[260px]">
          ...
          <div className="flex flex-col gap-2">
            <span className="font-ibm-mono text-[9px] text-[var(--c-text-faint)] tracking-[2px]">LANGUAGE</span>
          ...
          <div className="flex items-center gap-[8px] py-2 px-3 border border-[var(--c-accent)]/30 bg-[var(--c-accent)]/05 w-fit">
            ...
            <span className="font-ibm-mono text-[9px] text-[var(--c-accent)] tracking-[0.5px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 md:flex md:flex-1 gap-8 md:gap-[60px]">
          {[
            ...
            <div key={col.heading} className="flex flex-col gap-4 md:gap-[20px]">
              <span className="font-grotesk text-[11px] font-bold text-[var(--c-text)] tracking-[2px]">
                {col.heading}
              </span>
              {col.links.map((link) => (
                <a
                  key={link}
                  href="#"
                  className="font-ibm-mono text-[11px] text-[var(--c-text-muted)] tracking-[0.5px] hover:text-[#AAAAAA] transition-colors"
                >
                  {link}
                </a>
              ))}
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full px-6 md:px-[120px] py-4 md:h-[56px] border-t border-t-[var(--c-border-soft)] gap-3 sm:gap-0">
        <span className="font-ibm-mono text-[10px] text-[var(--c-text-dim)] tracking-[0.5px]">
          &copy; 2025 ETHIOPIAN AVIATION ACADEMY. ALL RIGHTS RESERVED.
        </span>
        <div className="flex items-center gap-6 md:gap-[32px]">
          <a href="#" className="font-ibm-mono text-[10px] text-[var(--c-text-dim)] tracking-[0.5px] hover:text-[var(--c-text-sub)] transition-colors">
            PRIVACY POLICY
          </a>
          <a href="#" className="font-ibm-mono text-[10px] text-[var(--c-text-dim)] tracking-[0.5px] hover:text-[var(--c-text-sub)] transition-colors">
            EEO STATEMENT
          </a>
          <a href="mailto:support@eaarecruit.et" className="font-ibm-mono text-[10px] text-[var(--c-text-dim)] tracking-[0.5px] hover:text-[var(--c-text-sub)] transition-colors">
            CONTACT SUPPORT
          </a>
          <span className="font-ibm-mono text-[10px] font-bold text-[var(--c-accent)] tracking-[1px]">
            V1.0
          </span>
        </div>
      </div>
